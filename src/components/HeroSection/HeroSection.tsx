...
const HeroSection = () => {
  return (
    <section className="w-full flex items-center justify-center bg-black p-4 lg:h-screen md:h-65vh h-45vh">
      <div className="text-center mx-auto">
        ...
        <div className="flex justify-center space-x-4 mt-4">
          <Link href="https://store.steampowered.com/app/1406090/ControlOverride/">
            <span className={`inline-block ${classes.buyIcon} text-white font-bold py-2 px-4 xl:py-3 xl:px-6 rounded transition duration-300`}>
              BUY NOW
            </span>
          </Link>
          <Link href="https://drive.google.com/drive/folders/1cInz9pylfEsPm-2y3p5G-49LSlsiVw44?fbclid=IwAR0v7tcjbP1m_3iQ28pPmFCh42VNuKjlOLlIOWQ3L-xipwj19-qnXvo8s58">
            <span className={`inline-block ${classes.pressKit} text-white font-bold py-2 px-4 xl:py-3 xl:px-6 rounded transition duration-300`}>
              PRESS KIT
            </span>
          </Link>
        </div>
